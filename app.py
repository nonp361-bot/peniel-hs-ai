                ...
                # [분기 1-2] 동아리 특기사항 전용 피드백
                    ...
                    {{
                        "club_eval": {{
                            ...
                            "revision_examples": "▍[2번. 관찰 결여]\\n- 수정 전: '동아리 활동에 참여함.'\\n- 수정 후: '지역 아동센터 방문 봉사 계획 수립 과정에서 예산 배분을 두고 의견이 갈리자 절충안을 제시하는 조율 능력을 보임.' (막연한 '활동'을 실제 다룬 구체적 상황으로 대체하여 보강)\\n- 동일 유형이므로 같은 방식으로 수정 가능한 문장: '자료를 조사하여 보고서를 작성함.'\\n\\n(improvements에서 정리한 모든 항목·모든 그룹에 대해 위와 같은 형식으로 빠짐없이 이어서 작성할 것)"
                        }}
                    }}
                    """
