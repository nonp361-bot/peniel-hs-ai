        ...
        if st.button("🔥 선택한 버전으로 AI 정밀 평가 시작하기", type="primary", use_container_width=True, key="start_eval_btn"):
            with st.spinner(f"🧠 AI 사정관이 [{evaluator_mode}] 관점에서 [{selected_feedback_type}] 맞춤 정밀 검증을 진행 중입니다..."):
                ...
                if selected_feedback_type == "과목세부능력 특기사항 전용 피드백":
                    ...
                    - good_points에서 2번 항목을 우수 사례로 꼽을 때는, 반드시 "교사의 평가/해석이 담긴 부분"을 정확히 지목해서 인용하세요. 만약 세특 전체에 '행위 나열'만 있고 이런 평가적 서술이 없다면, 이는 good_points가 아니라 improvements에서 "활동 사실만 나열되어 있고 교사의 관찰·평가가 결여됨"이라고 명확히 지적하고, 어떤 문장에 어떤 관찰·평가 내용을 보강해야 하는지 구체적으로 제안하세요.
                    ...
                    {{
                        "setuk_eval": {{
                            ...
                            "good_points": "1~3번 항목 기준, 원문 문장을 직접 인용하며 어떤 지점에서 교과 역량·교사 관찰·교과 사고방식이 잘 드러났는지 촘촘하게 짚은 분석 (단, 2번 교사 관찰 항목은 단순 활동/발표 사실 나열 문장이 아니라 그 활동에 대한 교사의 정성적 평가·해석이 담긴 문장만을 우수 사례로 인용할 것)",
                            "improvements": "4~6번 항목 기준, 복붙 의심 문장 대조, AI스러운 거대 담론·어색한 표현, 수식어 중첩·주술 불일치·목적어 누락 등 가독성 문제를 원문 인용과 함께 매우 구체적이고 냉정하게 지적한 내용. 아울러 2번 항목에서 활동 사실만 나열되고 교사의 평가·해석이 결여된 문장이 있다면 반드시 이곳에 지적하고 어떤 관찰·평가 내용을 보강해야 할지 제안할 것 (단, '-습니다'체로 고치라는 피드백은 절대 포함하지 말 것)",
                ...
                # [분기 1-2] 동아리 특기사항 전용 피드백
                    ...
                    {{
                        "club_eval": {{
                            ...
                            "improvements": "구체적 관찰 사실 부족(활동 사실만 나열되고 교사의 평가·해석이 결여된 경우 포함), 복붙 표현, 금지사항 등 구체적 감점 및 보완점 사유 (단, '-습니다'체로 고치라는 피드백은 절대 포함하지 말 것)",
                            "revision_examples": "진부하거나 미흡한 문장을 꼽고 교사 관찰 및 교과 연계 중심으로 어떻게 수정할지, 명사형 종결을 유지한 채 '수정 전 ➔ 수정 후' 예시 작성"
                        }}
                    }}
                    """
